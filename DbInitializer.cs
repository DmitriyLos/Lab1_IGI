...
namespace Lab1.Models
{
    public static class DbInitializer
    {
        ...
        private static void InitializePosts(STOContext db, int postsNumber)
        {
        ...
        private static void InitializeParts(STOContext db, int partsNumber)
        {
        ...
        private static void InitializeWorkers(STOContext db, int workersNumber, int postsNumber)
        {
        ...
        private static void InitializeBreakdowns(STOContext db, int breakdownsNumber, int ordersNumber, int partsNumber, int workersNumber)
        {
